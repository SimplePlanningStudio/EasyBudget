...
object CurrencyHelper {
     ...
     */
    private val MAIN_CURRENCIES =
        arrayOf("USD", "EUR", "GBP", "IRN", "AUD", "CAD", "SGD", "CHF", "MYR", "JPY", "CNY", "NZD")
...
// ----------------------------------------->
     ...
     */
    fun getFormattedCurrencyString(appPreferences: AppPreferences, amount: Double): String {
        ...
        currencyFormat.currency = appPreferences.getUserCurrency()
