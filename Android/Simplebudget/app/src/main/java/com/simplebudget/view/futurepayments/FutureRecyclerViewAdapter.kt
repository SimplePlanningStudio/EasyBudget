 ...
 */
class FutureRecyclerViewAdapter(
    private val expenses: List<Expense>,
    private val revenues: List<Expense>,
    private val allExpensesOfThisMonth: List<FutureExpenseViewModel.SuperParent>,
...
// --------------------------------------->
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        if (holder is HeaderViewHolder) {
            val obj = getExpense(position) as FutureExpenseViewModel.Parent
            val amountSpend =
            ...
            val obj = getExpense(position) as FutureExpenseViewModel.Child
    ...
    override fun getItemViewType(position: Int) =
        if (getExpense(position) is FutureExpenseViewModel.Parent) HEADER_VIEW_TYPE else EXPENSE_VIEW_TYPE
     ...
     */
    private fun getExpense(position: Int): FutureExpenseViewModel.SuperParent =
