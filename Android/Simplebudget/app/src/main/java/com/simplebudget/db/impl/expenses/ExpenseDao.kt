...
interface ExpenseDao {
    ...
    suspend fun searchExpenses(search_query: String,startDate: LocalDate, endDate: LocalDate, accountId: Long, amount:Double, minusAmount:Double): List<ExpenseEntity>
